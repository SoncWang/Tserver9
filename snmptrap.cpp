...
void initHUAWEIALARM()
{
	...
	HUAWEIDevAlarm.hwair_cond_infan_alarm2="0";		//空调内风机故障
	HUAWEIDevAlarm.hwair_cond_outfan_alarm="0";		//空调外风机故障
	HUAWEIDevAlarm.hwair_cond_outfan_alarm2="0";		//空调外风机故障
	HUAWEIDevAlarm.hwair_cond_comp_alarm="0";		//空调压缩机故障
	HUAWEIDevAlarm.hwair_cond_comp_alarm2="0";		//空调压缩机故障
	HUAWEIDevAlarm.hwair_cond_return_port_sensor_alarm="0";		//空调回风口传感器故障
	HUAWEIDevAlarm.hwair_cond_return_port_sensor_alarm2="0";		//空调回风口传感器故障
	HUAWEIDevAlarm.hwair_cond_evap_freezing_alarm="0";		//空调蒸发器冻结
	HUAWEIDevAlarm.hwair_cond_evap_freezing_alarm2="0";		//空调蒸发器冻结
	HUAWEIDevAlarm.hwair_cond_freq_high_press_alarm="0";		//空调频繁高压力
	HUAWEIDevAlarm.hwair_cond_freq_high_press_alarm2="0";		//空调频繁高压力
	HUAWEIDevAlarm.hwair_cond_comm_fail_alarm="0";		//空调通信失败告警
	HUAWEIDevAlarm.hwair_cond_comm_fail_alarm2="0";		//空调通信失败告警
	//新增加告警
