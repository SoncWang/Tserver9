...
#define NETSNMP_CONFIGURE_OPTIONS " '--host=arm-poky-linux' '--target=arm-poky-linux' '--build=i686-linux' '--prefix=/opt/xr/9100dll/net-snmp-5.8/install' '--disable-shared' '--disable-scripts' '--with-endianness=little' '-enable-mini-agent' '--disable-ipv6' '--disable-manuals' '--disable-ucd-snmp-compatibility' '--enable-as-needed' 'build_alias=i686-linux' 'host_alias=arm-poky-linux' 'target_alias=arm-poky-linux' 'CC=arm-poky-linux-gnueabi-gcc  -march=armv7-a -mthumb-interwork -mfloat-abi=hard -mfpu=neon -mtune=cortex-a9 --sysroot=/opt/poky/1.7/sysroots/cortexa9hf-vfp-neon-poky-linux-gnueabi' 'CFLAGS= -O2 -pipe -g -feliminate-unused-debug-types' 'LDFLAGS=-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed' 'CPPFLAGS=' 'CPP=arm-poky-linux-gnueabi-gcc -E  -march=armv7-a -mthumb-interwork -mfloat-abi=hard -mfpu=neon -mtune=cortex-a9 --sysroot=/opt/poky/1.7/sysroots/cortexa9hf-vfp-neon-poky-linux-gnueabi' 'PKG_CONFIG_PATH=/opt/poky/1.7/sysroots/cortexa9hf-vfp-neon-poky-linux-gnueabi/usr/lib/pkgconfig'"
...
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/opt/xr/9100dll/net-snmp-5.8/install/share/snmp/mibs"
...
#define NETSNMP_DEFAULT_MIBS ":SNMPv2-MIB:IF-MIB:IP-MIB:TCP-MIB:UDP-MIB:SNMP-VIEW-BASED-ACM-MIB:SNMP-COMMUNITY-MIB:SNMP-FRAMEWORK-MIB:SNMP-MPD-MIB:SNMP-USER-BASED-SM-MIB"
...
#define SNMPLIBPATH "/opt/xr/9100dll/net-snmp-5.8/install/lib/snmp"
#define SNMPSHAREPATH "/opt/xr/9100dll/net-snmp-5.8/install/share/snmp"
#define SNMPCONFPATH "/opt/xr/9100dll/net-snmp-5.8/install/etc/snmp"
#define SNMPDLMODPATH "/opt/xr/9100dll/net-snmp-5.8/install/lib/snmp/dlmod"
