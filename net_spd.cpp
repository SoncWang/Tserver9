...
UINT8 SPD_Address[SPD_NUM+RES_NUM] = {SPD_DEFALT_ADDR,SPD_DEFALT_ADDR,SPD_DEFALT_ADDR,SPD_DEFALT_ADDR,SPD_DEFALT_ADDR};
...
void DataGet_Thread_Create(UINT16 SPD_t)
{
	...
	if ((SPD_t == TYPE_LEIXUN) || (SPD_t == TYPE_KY))
	{
