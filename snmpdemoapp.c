...
{  
    ...
    session.peername = strdup("128.8.82.231");  
    ...
    if (generate_Ku(session.securityAuthProto,  
                    ...
                    (u_char *) our_v2c_passphrase, strlen(our_v2c_passphrase),  
...
{ 
    ...
    fd = open("./data.txt",O_RDWR | O_EXCL | O_APPEND,S_IRWXU); 
    if(write(fd, sp, sizeof(sp)) == sizeof(sp)) 
        return 0; 
    else{ 
        printf("iput bug\n"); 
        return -1; 
